...
const RigthSignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validateUsername()) {
      alert(
        "Username must be at least 1 character and include letters, numbers"
      );
      return;
    }
    ...
    <div className="w-full md:w-1/2 flex justify-center items-center font-sans mt-10 md:mt-3">
      <div className="text-center w-4/5">
        <div className="flex items-center mb-4">
          ...
          <p
            style={{ color: "#390A75" }}
            className="mb-0 font-bold text-2xl md:text-3xl lg:text-4xl"
          >
            Hitch
          </p>
        </div>
        ...
        <h1
          style={{ color: "#525252" }}
          className="text-xl md:text-2xl lg:text-3xl font-bold text-left"
        >
        ...
        <h3
          style={{ color: "#525252" }}
          className="text-xs md:text-sm lg:text-base mb-4 md:mb-6 lg:mb-8 text-left"
        >
        ...
        <div className="mb-6 grid-cols-1 grid md:grid-cols-2 grid gap-4">
          <div className="col-span-full">
            <label
              htmlFor="name"
              style={{ color: "#828282" }}
              className="block text-left text-xs md:text-sm lg:text-base font-bold mb-1"
            >
              Name
            </label>
            <input
          ...
          <div className="flex items-center mb-4 col-span-2">
            ...
            <a
              href="/"
              style={{ color: "#390A75" }}
              className="ml-auto font-bold text-xs md:text-sm lg:text-base"
            >
              Forgot Password?
            </a>
          </div>
