    ...
    return (
        <div className='pl-32 pr-28 pt-14 flex flex-col md:flex-row bg-[#F9F8FE] max-sm:justify-center max-sm:pl-4 max-sm:pb-24 max-xl:px-4 max-sm:relative'>
            <section className='flex flex-col mr-36  max-sm:w-full max-md:mr-0 '>
                ...
                <aside className='flex items-center justify-between max-w-sm mt-11 max-sm:mt-6 max-sm:mr-5 max-sm:relative'>
                <svg className="max-sm:w-28 max-sm:h-5 " xmlns="http://www.w3.org/2000/svg" width="142" height="26" viewBox="0 0 142 26" fill="none">
                ...
                <span className='text-lg font-medium max-sm:text-sm max-sm:font-normal'><strong>4.9</strong> / 5 rating</span>
                <span className='text-lg text-text font-bold max-sm:text-sm'>Hitch</span>
                <aside className="absolute h-40 w-52 blur-3xl -left-10 -mb-24 rounded-br-full  hidden bg-primary/30 max-sm:block"></aside>
                </aside>
            </section>
            ...
            <section className='flex flex-col justify-between max-md:mt-16 max-sm:z-10'>
                <aside className='grid auto-cols-auto gap-x-5 gap-y-2 max-sm:gap-y-0 max-sm:gap-x-3'>
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-lg max-sm:text-primary-dark'>Centralized Filtered File Sharing</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-xs max-sm:text-[#3B3B3B] max-sm:-mt-2'>Users can share files within channels, and the platform automatically categorizes and tags documents for efficient organization.</p>
                </aside>

                <aside className='grid auto-cols-auto gap-x-5 gap-y-2 mt-3 max-sm:gap-y-0 max-sm:gap-x-3 max-sm:mt-9'>
                    <span className='flex w-14 h-14 justify-center items-center rounded-lg shadow-2xl bg-white max-sm:w-10 max-sm:h-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-lg max-sm:text-primary-dark'>Intuitive Channel Management</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-sm max-sm:text-[#3B3B3B] max-sm:-mt-2'> Users can define and manage workspaces seamlessly by creating multiple channels, each dedicated to specific topics or projects.</p>
                </aside>

                <aside className='grid auto-cols-auto gap-x-5 gap-y-2 mt-3 max-sm:gap-y-0 max-sm:gap-x-3 max-sm:mt-9'>
                    <span className='flex w-14 h-14 justify-center rounded-lg items-center shadow-2xl bg-white max-sm:w-10 max-sm:h-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-lg max-sm:text-primary-dark'>Dynamic Huddle Sessions</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-sm max-sm:text-[#3B3B3B] max-sm:-mt-2'>Users can seamlessly initiate and join audio and video huddle sessions within channels, fostering real-time communication and enhancing teamwork.</p>
                </aside>
            </section>
            {/* Blur effect */}
            <aside className="absolute h-28 w-44 right-0 -bottom-10 hidden blur-2xl bg-primary/40 max-sm:block -z:10"></aside>
        </div>
    )
}
