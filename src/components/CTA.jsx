...
{
    return (
        <div className='pl-32 pr-28 pt-14 flex flex-col md:flex-row bg-[#F9F8FE] max-sm:pl-4'>
            <section className='flex flex-col mr-36 max-sm:mb-4 max-sm:w-full'>
                <h1 className='text-5xl font-semibold max-sm:text-3xl'>Hitch a ride to collaboration, and teamwork takes flight.</h1>
                <p className='text-text font-medium leading-[30px] mt-2 max-sm:leading-5'>Hitch: Unleashing creativity with structured channels, real-time huddle sessions, and efficient file sharing—a platform where collaboration becomes an inspiring journey.</p>
                ...
                <span className='text-lg font-medium max-sm:ml-5'><strong>4.9</strong> / 5 rating</span>
                <span className='text-lg text-text font-bold'>Hitch</span>
                </aside>
            </section>
            <section className='flex flex-col justify-between'>
                <aside className='grid auto-cols-auto gap-x-5 gap-y-2'>
                    <span className='flex w-14 h-14 justify-center items-center shadow-2xl bg-white max-sm:w-10 max-sm:h-10'>
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-xl'>Centralized Filtered File Sharing</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-sm'>Users can share files within channels, and the platform automatically categorizes and tags documents for efficient organization.</p>
                </aside>
                <aside className='grid auto-cols-auto gap-x-5 gap-y-2 mt-3'>
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-xl'>Intuitive Channel Management</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-sm'> Users can define and manage workspaces seamlessly by creating multiple channels, each dedicated to specific topics or projects.</p>
                </aside>
                <aside className='grid auto-cols-auto gap-x-5 gap-y-2 mt-3'>
                    <span className='flex w-14 h-14 justify-center items-center shadow-2xl bg-white max-sm:w-10 max-sm:h-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <h1 className='text-3xl font-bold max-sm:text-xl'>Dynamic Huddle Sessions</h1>
                    <p className='text-lg text-text font-medium col-start-2 max-sm:text-sm'>Users can seamlessly initiate and join audio and video huddle sessions within channels, fostering real-time communication and enhancing teamwork.</p>
                </aside>
            </section>
        </div>
    )
