...
const NavbarMobile = () => {
  ...
  return (
    <div className='sticky top-0'>
                            <nav className='ml-4 mr-6 pt-5  box-content flex justify-between items-center py-3'>

                                <div className='flex gap-3 items-center'>
                                    <img src="./images/logo.svg" className='w-14 h-14' />
                                ...
                                <button onClick={() => setNavbar(!navbar)} class="relative lg:hidden">
                                    ...
                                    <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 2H26.6667" stroke="#FFEAEA" stroke-width="4" stroke-linecap="round" />
                                        <path d="M2 10.6667H26.6667" stroke="#FFEAEA" stroke-width="4" stroke-linecap="round" />
                                        <path d="M2 20H26.6667" stroke="#FFEAEA" stroke-width="4" stroke-linecap="round" />
                                    </svg>
                                </button>
                            </nav>
                            {navbar ? (
                                <div class="sm:hidden py-3 pl-10 pb-5  w-full h-fit flex flex-col top-3 space-y-4 ">
                                    <span className='text-white text-lg font-medium hover:cursor-pointer hover:text-white'>Home</span>
