    ...
    <div className='flex md:flex-row'>
      ...
      <div className='w-full md:w-1/2 flex justify-center items-center font-sans mt-10 md:mt-3'>
        <div className='text-center w-4/5'>
          ...
          <p style={{color: "#A1A1A1"}} className='mb-2 md:mb-4 lg:mb-6 text-xs md:text-sm lg:text-base'>------------- or Sign Up with Email -------------</p>
          ...
          <form className='mb-6' onSubmit={handleSubmit}>
            ...
            <div className='mb-4'>
              <label htmlFor='password' style={{color: "#828282"}} className='text-left block text-xs md:text-sm lg:text-base font-bold mb-1'>Name</label>
              <input
                type='text'
                id='name'
            ...
            <div className='mb-4'>
              <label htmlFor='password' style={{color: "#828282"}} className='text-left block text-xs md:text-sm lg:text-base font-bold mb-1'>Username</label>
              <input
                type='text'
                id='username'
