      ...
      <div className='w-full md:w-1/2 flex justify-center items-center font-sans mt-10 md:mt-3'>
        <div className='text-center w-4/5'>
          ...
          <div className='flex items-center mb-4'>
            ...
            {/* Logo Name */}
            <p className='mb-0 text-purple-800 font-bold text-lg md:text-xl lg:text-2xl'>Hitch</p>
          </div>

          {/* Login to Your Account */}
          <h1 className='text-xl md:text-2xl lg:text-3xl font-bold text-left'>Login to Your Account</h1>

          <h3 className='font-bold text-xs md:text-sm lg:text-base mb-4 md:mb-6 lg:mb-8 text-left'>
          ...
          <button className='rounded-md  border border-0.5 border-radius-9 px-2 md:px-4 py-1 md:py-2 mb-4 md:mb-6 lg:mb-8 flex items-center justify-center w-full'>
            ...
            <span className='text-black text-xs md:text-sm lg:text-base'>Continue with Google</span>
          </button>

          {/* OR */}
          <p className='mb-2 md:mb-4 lg:mb-6 text-xs md:text-sm lg:text-base'>------------- or Sign in with Email -------------</p>
          ...
          <form className='mb-6' onSubmit={handleSubmit}>
            ...
            <div className='flex items-center mb-4'>
              ...
              <span className='text-xs md:text-sm lg:text-base'>Remember me</span>
              <a href='/' className='ml-auto text-purple-800 font-bold text-xs md:text-sm lg:text-base'>Forgot Password?</a>
            </div>
            <button
              type='submit'
